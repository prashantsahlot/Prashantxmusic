...
OWNER_ID = int(getenv("OWNER_ID", 1668494031))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/prashantsahlot/Prashantxmusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/prashant_xmusic")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/AKATSUKI_OFFICIAL_0")
